...
C
C     SETUP FOR THE CASPIAN CLIMATOLOGY
C
      INTEGER    IWI,JWI,KWI
      REAL*4     XFIN,YFIN,DXIN,DYIN
      PARAMETER (IWI=37, JWI=57, KWI=19)
      PARAMETER (XFIN=46.0, YFIN=36.2, DXIN=0.25, DYIN=0.2)
C
C     CLIM ARRAYS.
C
...
c --- find a cubic polynominal root of t**3+a2*t**2+a1*t+a0=0
      tofsig(r,s)=-cubrl(r,s)+sqrt(3.0)*cubim(r,s)-dthird*a2(s)
c
