...
c
      ...
      write(no,'(a,2f14.7)') 'min,max depth = ',hmina,hmaxa
      call flush(no)
      write(lp,'(a,2f14.7)') 'min,max depth = ',hmina,hmaxa
      call flush(lp)
c
      call zbiocl(no)
      close( unit=no)
...
c
     ...
     &              '   i,j,ss,a = ',i,j,ss,a(i,j)
          ...
          enddo
        enddo
        write(6,'(a,i4,a,i9,a)') 'landfill: pass',ipass,
