...
C
C 5)  THIS IS FOR HP-UX DATE THAT RETURNS A 9 CHARACTER STRING
C     '16-SEP-84' - S. D. Jacob, October 2002. 
C
C*
C**********
C
...
C
C 2) THIS VERSION FOR HP-UX. S. D. Jacob, October 2002.
C
