...
C
C     SETUP FOR 30 arc-second "bedrock" DATA (extended 2deg across poles).
C       https://www.earth-syst-sci-data.net/8/543/2016/
C       https://doi.pangaea.de/10.1594/PANGAEA.856844 (2016 data)
C       https://doi.pangaea.de/10.1594/PANGAEA.905295?format=html#download  (updated 2019)
C
C     92S+00sec is at j=     1
C     90S+00sec is at j=   241
C      0S-00sec is at j= 11040
C      0S+00sec is at j= 11041
C     90N-00sec is at j= 21840
C     92N-00sec is at j= 22080
C
      INTEGER    IWI,JWI,JWI90
      REAL*8     XFIN,YFIN,DXIN,DYIN
      PARAMETER (IWI =43201,    JWI =22080,  JWI90=21601)
      PARAMETER (DXIN=1.D0/120.D0,        DYIN=1.D0/120.D0)
      PARAMETER (XFIN=-180.D0+0.0D0*DXIN, YFIN=-92.D0+0.0D0*DYIN)
C
C     BATHTMETRY ARRAYS.
C
